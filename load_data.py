...
from dashboard.models import Geolocation  # Now you can import your models
...
def parse_date(date_str):
    try:
        ...
        return timezone.localize(naive_datetime)  # Make the datetime object timezone-aware
    except ValueError:
